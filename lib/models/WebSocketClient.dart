...
class WebSocketUtility {
  ...
  static final String URL = "ws://10.0.20.185:8090/ws";
  ...
  final int _heartTimes = 5000; // 心跳间隔(毫秒)
  ...
  void sentHeart() {
    ...
    WebSocketRequest.buildStringRequest("heartBeat");
    sendMessage(webSocketRequest.toJson());
  }
